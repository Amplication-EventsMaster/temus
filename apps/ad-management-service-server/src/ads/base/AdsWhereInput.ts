...
import { CategoriesListRelationFilter } from "../../categories/base/CategoriesListRelationFilter";
...
class AdsWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => CategoriesListRelationFilter,
  })
  @ValidateNested()
  @Type(() => CategoriesListRelationFilter)
  @IsOptional()
  @Field(() => CategoriesListRelationFilter, {
    nullable: true,
  })
