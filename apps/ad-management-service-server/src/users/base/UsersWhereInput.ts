...
import { OrganizationsListRelationFilter } from "../../organizations/base/OrganizationsListRelationFilter";
...
class UsersWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => OrganizationsListRelationFilter,
  })
  @ValidateNested()
  @Type(() => OrganizationsListRelationFilter)
  @IsOptional()
  @Field(() => OrganizationsListRelationFilter, {
    nullable: true,
  })
