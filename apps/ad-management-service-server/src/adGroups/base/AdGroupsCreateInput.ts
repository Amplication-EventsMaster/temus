...
@InputType()
class AdGroupsCreateInput {
  @ApiProperty({
    required: false,
    type: () => AdsCreateNestedManyWithoutAdGroupsItemsInput,
  })
  @ValidateNested()
  @Type(() => AdsCreateNestedManyWithoutAdGroupsItemsInput)
  @IsOptional()
  @Field(() => AdsCreateNestedManyWithoutAdGroupsItemsInput, {
    nullable: true,
  })
...
export { AdGroupsCreateInput as AdGroupsCreateInput };
