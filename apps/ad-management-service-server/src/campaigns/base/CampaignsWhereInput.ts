...
import { AdGroupsListRelationFilter } from "../../adGroups/base/AdGroupsListRelationFilter";
...
@InputType()
class CampaignsWhereInput {
  @ApiProperty({
    required: false,
    type: () => AdGroupsListRelationFilter,
  })
  @ValidateNested()
  @Type(() => AdGroupsListRelationFilter)
  @IsOptional()
  @Field(() => AdGroupsListRelationFilter, {
    nullable: true,
  })
...
export { CampaignsWhereInput as CampaignsWhereInput };
